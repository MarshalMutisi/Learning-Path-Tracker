      ...
      <section className='py-16 px-8 bg-white'>
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const mailtoLink = `mailto:support@learningpathtracker.dev?subject=Message from ${name}&body=Email: ${email}%0D%0A%0D%0A${message}`;
      ...
      <section className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
          <div>
            ...
            <p className='text-gray-600'>support@learningpathtracker.dev</p>
          </div>
          <div>
            ...
            <p className='text-gray-600'>
              ...
              <a
                href='https://discord.gg/learningpathtracker'
                target='_blank'
          ...
          <div>
            ...
            <p className='text-gray-600'>
              <a
                href='https://github.com/learningpathtracker'
                target='_blank'
                rel='noopener noreferrer'
                className='text-purple-600 hover:underline'
              >
                github.com/learningpathtracker
              </a>
            </p>
          </div>
        </div>
